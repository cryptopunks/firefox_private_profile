...
//Эти настройки говорят браузеру сопротивляться идентификации.
user_pref("dom.webaudio.enabled", false);
user_pref("privacy.resistFingerprinting", true);
//Перекрываем информацию о сетевом соединении
user_pref("dom.netinfo.enabled", false);
user_pref("dom.network.enabled", false);
//Отключаем использование устройств и передачу медиа
...
user_pref("dom.ipc.plugins.flash.subprocess.crashreporter.enabled",
false);
...
//Пуш‐уведомления могут работать даже тогда, когда ты закрыл страницу - теперь не могут
